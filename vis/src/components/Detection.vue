...
export default {
  ...
  computed: {
    ...mapState(["tree", "set_list", "focus_node", "expand_tree", "tooltip"]),
  },
  methods: {
    ...
    update_view() {
      ...
      this.e_nodes = this.tree_node_group
        .selectAll(".tree-node")
    ...
    node_create() {
      ...
      node_groups
        ...
        .on("click", (ev, d) => {
          ...
          this.$store.dispatch("fetch_word", query);
